...
Two different observers may choose different origins, but as long as they choose the same basis vectors, their results in $\mathbb{R}^N$ will be consistent. But note that we have made an interesting assumption here, that there is such a thing as "the same basis vector" at two different points.
