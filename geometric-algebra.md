...
Combining two vectors in this way to form a parallelogram is the _external product_, and because if we exchange the vectors the product is negated, we say it is _anticommutative_:
